    ...
    return (
        <div className="lg:flex items-center justify-between w-full">
            ...
            <div className="flex flex-col gap-5 mx-5">
                ...
                <h1  className={`${montSerrat.variable} antialiased text-2xl lg:text-4xl dark:text-white text-black font-bold line-clamp-5 leading-snug`}>The Meal Mate Redefining <br />The Art of Exquisite Quality Foods</h1>
