  ...
  return (
    <div className="relative min-h-screen w-full flex items-center justify-center overflow-hidden">
      <div className="absolute inset-0 z-0">
        <Image src="/bg.jpg" alt="Night Stars Forest" fill className="object-cover" priority />
      </div>
        ...
        >
          ...
          <form.Subscribe
            ...
            children={([canSubmit, isSubmitting]) => (
              <button  type="submit" disabled={!canSubmit}className="w-full h-12 bg-white text-gray-900 font-bold rounded-full shadow-lg hover:bg-gray-100 transition-all flex items-center justify-center gap-2 disabled:opacity-50">
          ...
          <button type="submit" onClick={loginWithGoogle} className="w-full cursor-pointer h-12 bg-transparent border-2 border-white/20 rounded-full hover:bg-white/10 transition-all flex items-center justify-center gap-2" >
