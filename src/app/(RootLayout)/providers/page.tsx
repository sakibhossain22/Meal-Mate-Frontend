...
import { Phone, MapPin, ArrowRight, Store, Utensils } from 'lucide-react';
            ...
            <div className="max-w-6xl mx-auto">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    {providers.map((provider: any) => (
                        <Card key={provider.id} className="group relative overflow-hidden rounded-[2.5rem] border-none bg-white dark:bg-slate-900 shadow-xl shadow-slate-200/60 dark:shadow-none dark:border dark:border-slate-800 transition-all duration-500 hover:-translate-y-2">
                            <CardContent className="p-0">
                                <div className="h-32 bg-gradient-to-r from-orange-400 to-red-500 relative">
                                    ...
                                    <Badge className="absolute top-4 right-6 bg-white/20 backdrop-blur-md text-white border-none">{provider.meals?.length || 0} Meals </Badge>
                                </div>
                                ...
                                <div className="pt-14 p-8 space-y-4">
                                    <div>
                                        ...
                                        <p className="text-sm text-slate-500 dark:text-slate-400 line-clamp-2 mt-2">{provider.description}</p>
                                    </div>
                                    ...
                                    <div className="pt-4">
                                        <Link
                                            href={`/providers/${provider.id}`} className="inline-flex w-full items-center justify-center gap-2 rounded-full bg-[#fbb200] px-4 py-3 font-semibold text-black transition-all duration-300 hover:bg-[#f22e3e] hover:text-white hover:shadow-lg dark:bg-[#f22e3e] dark:text-white dark:hover:bg-[#ff5a67]">
                                            <Utensils size={18} />
                                            Show Meals
